...
/** USING DESTRUCTURING FOR IMPORTS **/

// Use destructuring to import only the last two functions from utils.js
const { getRandNum, getTitleCase } = require('./common/utils.js');

// Use destructuring to import the question function from the readline-sync library
